...
class FluxControlNetInpaintingPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    """
    Pipeline for text-to-image generation with ControlNet guidance for inpainting.
    """
    ...
    def __call__(
        ...
        """
        Function invoked when calling the pipeline for generation with ControlNet guidance.
        """
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Transformer call with ControlNet guidance
